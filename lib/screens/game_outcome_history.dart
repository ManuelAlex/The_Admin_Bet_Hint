...
import 'package:admin_bet_hint/widghets/game_history_widget.dart';
...
class _GameHistoryScreenState extends State<GameHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: context.read<MenuController>().getgamesHistoryScalffoldKey,
                  ...
                  children: [
                    Header(
                      fct: () {
                        context
                            .read<MenuController>()
                            .controlGameHistoryDetailsMenu();
                      },
                      title: 'Games OutCome History',
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                          ...
                          DashboardButton(
                            ...
                            onpress: () {
                              globalMethods.navigateTo(
                                  ctx: context,
                                  routeName: AddGamescreen.routeName);
                            },
                            text: 'Add Game',
                          )
                        ],
